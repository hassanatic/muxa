...
def score(threshold: float = 0.8,
    ...
    stats = {"fallback_rate": fb, "assets": len(results),
             "recall_ok": overall >= threshold, "fallback_ok": fb <= max_fallback}
    return overall, per_file, (stats["recall_ok"] and stats["fallback_ok"]), stats
